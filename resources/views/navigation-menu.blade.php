        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if (auth()->user()->role_id == 1)
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link href="{{ route('adminpatients') }}" :active="request()->routeIs('adminpatients')">
                        {{ __('Patients') }}
                    </x-nav-link>
                    </div>
                    @endif
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link href="{{ route('doctorappointments') }}" :active="request()->routeIs('doctorappointments')">
                            Appointments
                        </x-nav-link>
                     </div>
                    @endif

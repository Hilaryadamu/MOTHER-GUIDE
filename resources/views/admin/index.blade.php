<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto py-10 sm:px-6 lg:px-8">
            ...
            <form action="/adminpatients" method="POST">
                    @csrf
